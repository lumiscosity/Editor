...
namespace Binding::Generated {
	...
	QList<int> TreeMap::tree_order() {
		return QList<int>(m_data.tree_order.begin(), m_data.tree_order.end());
	}
	void TreeMap::set_tree_order(const QList<int>& new_tree_order) {
		if (QList<int>(m_data.tree_order.begin(), m_data.tree_order.end()) == new_tree_order)
			return;
