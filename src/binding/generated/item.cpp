...
namespace Binding::Generated {
	...
	QList<bool> Item::actor_set() {
		return QList<bool>(m_data.actor_set.begin(), m_data.actor_set.end());
	}
	void Item::set_actor_set(const QList<bool>& new_actor_set) {
		if (QList<bool>(m_data.actor_set.begin(), m_data.actor_set.end()) == new_actor_set)
			return;
		m_data.actor_set = decltype(m_data.actor_set)(new_actor_set.begin(), new_actor_set.end());
		emit actor_set_changed();
	}

	QList<bool> Item::state_set() {
		return QList<bool>(m_data.state_set.begin(), m_data.state_set.end());
	}
	void Item::set_state_set(const QList<bool>& new_state_set) {
		if (QList<bool>(m_data.state_set.begin(), m_data.state_set.end()) == new_state_set)
			return;
		m_data.state_set = decltype(m_data.state_set)(new_state_set.begin(), new_state_set.end());
		emit state_set_changed();
	}

	QList<bool> Item::attribute_set() {
		return QList<bool>(m_data.attribute_set.begin(), m_data.attribute_set.end());
	}
	void Item::set_attribute_set(const QList<bool>& new_attribute_set) {
		if (QList<bool>(m_data.attribute_set.begin(), m_data.attribute_set.end()) == new_attribute_set)
			return;
	...
	QList<bool> Item::class_set() {
		return QList<bool>(m_data.class_set.begin(), m_data.class_set.end());
	}
	void Item::set_class_set(const QList<bool>& new_class_set) {
		if (QList<bool>(m_data.class_set.begin(), m_data.class_set.end()) == new_class_set)
			return;
