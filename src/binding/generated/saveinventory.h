...
class SaveInventory : public Binding::BindingBase {
	Q_OBJECT
	Q_PROPERTY(QList<int> party READ party WRITE set_party NOTIFY party_changed)
	Q_PROPERTY(QList<int> item_ids READ item_ids WRITE set_item_ids NOTIFY item_ids_changed)
	Q_PROPERTY(QList<int> item_counts READ item_counts WRITE set_item_counts NOTIFY item_counts_changed)
	Q_PROPERTY(QList<int> item_usage READ item_usage WRITE set_item_usage NOTIFY item_usage_changed)
...
public:
	...
	QList<int> party();
	void set_party(const QList<int>& new_party);
	QList<int> item_ids();
	void set_item_ids(const QList<int>& new_item_ids);
	QList<int> item_counts();
	void set_item_counts(const QList<int>& new_item_counts);
	QList<int> item_usage();
	void set_item_usage(const QList<int>& new_item_usage);
	int gold();
