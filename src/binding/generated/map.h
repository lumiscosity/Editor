...
class Map : public Binding::BindingBase {
	...
	Q_PROPERTY(QList<int> generator_x READ generator_x WRITE set_generator_x NOTIFY generator_x_changed)
	Q_PROPERTY(QList<int> generator_y READ generator_y WRITE set_generator_y NOTIFY generator_y_changed)
	Q_PROPERTY(QList<int> generator_tile_ids READ generator_tile_ids WRITE set_generator_tile_ids NOTIFY generator_tile_ids_changed)
	Q_PROPERTY(QList<int> lower_layer READ lower_layer WRITE set_lower_layer NOTIFY lower_layer_changed)
	Q_PROPERTY(QList<int> upper_layer READ upper_layer WRITE set_upper_layer NOTIFY upper_layer_changed)
...
public:
	...
	QList<int> generator_x();
	void set_generator_x(const QList<int>& new_generator_x);
	QList<int> generator_y();
	void set_generator_y(const QList<int>& new_generator_y);
	QList<int> generator_tile_ids();
	void set_generator_tile_ids(const QList<int>& new_generator_tile_ids);
	QList<int> lower_layer();
	void set_lower_layer(const QList<int>& new_lower_layer);
	QList<int> upper_layer();
	void set_upper_layer(const QList<int>& new_upper_layer);
	ArrayAdapter* events();
	int save_count_2k3e();
