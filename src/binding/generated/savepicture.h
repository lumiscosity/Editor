...
class SavePicture : public Binding::BindingBase {
	...
	Q_PROPERTY(int easyrpg_type READ easyrpg_type WRITE set_easyrpg_type NOTIFY easyrpg_type_changed)
	Q_PROPERTY(double maniac_current_magnify_height READ maniac_current_magnify_height WRITE set_maniac_current_magnify_height NOTIFY maniac_current_magnify_height_changed)
	Q_PROPERTY(int maniac_finish_magnify_height READ maniac_finish_magnify_height WRITE set_maniac_finish_magnify_height NOTIFY maniac_finish_magnify_height_changed)
...
public:
	...
	int easyrpg_type();
	void set_easyrpg_type(const int& new_easyrpg_type);
	double maniac_current_magnify_height();
	void set_maniac_current_magnify_height(const double& new_maniac_current_magnify_height);
	int maniac_finish_magnify_height();
	void set_maniac_finish_magnify_height(const int& new_maniac_finish_magnify_height);
...
signals:
	...
	void easyrpg_type_changed();
	void maniac_current_magnify_height_changed();
	void maniac_finish_magnify_height_changed();
