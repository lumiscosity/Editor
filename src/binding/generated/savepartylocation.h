...
class SavePartyLocation : public Binding::BindingBase {
	...
	Q_PROPERTY(int total_encounter_rate READ total_encounter_rate WRITE set_total_encounter_rate NOTIFY total_encounter_rate_changed)
...
public:
	...
	int total_encounter_rate();
	void set_total_encounter_rate(const int& new_total_encounter_rate);
...
signals:
	...
	void total_encounter_rate_changed();
