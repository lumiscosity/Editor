...
class State : public Binding::BindingBase {
	...
	Q_PROPERTY(QList<bool> easyrpg_immune_states READ easyrpg_immune_states WRITE set_easyrpg_immune_states NOTIFY easyrpg_immune_states_changed)
...
public:
	...
	QList<bool> easyrpg_immune_states();
	void set_easyrpg_immune_states(const QList<bool>& new_easyrpg_immune_states);
