...
class SaveMapEventBase : public Binding::BindingBase {
	...
	Q_PROPERTY(int facing READ facing WRITE set_facing NOTIFY facing_changed)
	...
	Q_PROPERTY(bool move_route_finished READ move_route_finished WRITE set_move_route_finished NOTIFY move_route_finished_changed)
	Q_PROPERTY(bool sprite_hidden READ sprite_hidden WRITE set_sprite_hidden NOTIFY sprite_hidden_changed)
	Q_PROPERTY(bool move_route_through READ move_route_through WRITE set_move_route_through NOTIFY move_route_through_changed)
...
public:
	...
	int facing();
	void set_facing(const int& new_facing);
	int anim_frame();
	...
	bool move_route_finished();
	void set_move_route_finished(const bool& new_move_route_finished);
	bool sprite_hidden();
	void set_sprite_hidden(const bool& new_sprite_hidden);
	bool move_route_through();
	void set_move_route_through(const bool& new_move_route_through);
	int anim_paused();
...
signals:
	...
	void move_route_finished_changed();
	void sprite_hidden_changed();
	void move_route_through_changed();
