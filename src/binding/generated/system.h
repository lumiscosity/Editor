...
class System : public Binding::BindingBase {
	...
	Q_PROPERTY(QList<int> menu_commands READ menu_commands WRITE set_menu_commands NOTIFY menu_commands_changed)
	...
	Q_PROPERTY(QList<int> easyrpg_battle_options READ easyrpg_battle_options WRITE set_easyrpg_battle_options NOTIFY easyrpg_battle_options_changed)
...
public:
	...
	QList<int> menu_commands();
	void set_menu_commands(const QList<int>& new_menu_commands);
	...
	QList<int> easyrpg_battle_options();
	void set_easyrpg_battle_options(const QList<int>& new_easyrpg_battle_options);
