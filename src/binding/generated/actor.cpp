...
namespace Binding::Generated {
	...
	QList<int> Actor::state_ranks() {
		return QList<int>(m_data.state_ranks.begin(), m_data.state_ranks.end());
	}
	void Actor::set_state_ranks(const QList<int>& new_state_ranks) {
		if (QList<int>(m_data.state_ranks.begin(), m_data.state_ranks.end()) == new_state_ranks)
			return;
		m_data.state_ranks = decltype(m_data.state_ranks)(new_state_ranks.begin(), new_state_ranks.end());
		emit state_ranks_changed();
	}

	QList<int> Actor::attribute_ranks() {
		return QList<int>(m_data.attribute_ranks.begin(), m_data.attribute_ranks.end());
	}
	void Actor::set_attribute_ranks(const QList<int>& new_attribute_ranks) {
		if (QList<int>(m_data.attribute_ranks.begin(), m_data.attribute_ranks.end()) == new_attribute_ranks)
			return;
	...
	QList<int> Actor::battle_commands() {
		return QList<int>(m_data.battle_commands.begin(), m_data.battle_commands.end());
	}
	void Actor::set_battle_commands(const QList<int>& new_battle_commands) {
		if (QList<int>(m_data.battle_commands.begin(), m_data.battle_commands.end()) == new_battle_commands)
			return;
	...
	QList<bool> Actor::easyrpg_unarmed_state_set() {
		return QList<bool>(m_data.easyrpg_unarmed_state_set.begin(), m_data.easyrpg_unarmed_state_set.end());
	}
	void Actor::set_easyrpg_unarmed_state_set(const QList<bool>& new_easyrpg_unarmed_state_set) {
		if (QList<bool>(m_data.easyrpg_unarmed_state_set.begin(), m_data.easyrpg_unarmed_state_set.end()) == new_easyrpg_unarmed_state_set)
			return;
	...
	QList<bool> Actor::easyrpg_unarmed_attribute_set() {
		return QList<bool>(m_data.easyrpg_unarmed_attribute_set.begin(), m_data.easyrpg_unarmed_attribute_set.end());
	}
	void Actor::set_easyrpg_unarmed_attribute_set(const QList<bool>& new_easyrpg_unarmed_attribute_set) {
		if (QList<bool>(m_data.easyrpg_unarmed_attribute_set.begin(), m_data.easyrpg_unarmed_attribute_set.end()) == new_easyrpg_unarmed_attribute_set)
			return;
