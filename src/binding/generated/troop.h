...
class Troop : public Binding::BindingBase {
	...
	Q_PROPERTY(QList<bool> terrain_set READ terrain_set WRITE set_terrain_set NOTIFY terrain_set_changed)
...
public:
	...
	QList<bool> terrain_set();
	void set_terrain_set(const QList<bool>& new_terrain_set);
