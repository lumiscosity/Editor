...
namespace Binding::Generated {
	...
	QList<bool> State::easyrpg_immune_states() {
		return QList<bool>(m_data.easyrpg_immune_states.begin(), m_data.easyrpg_immune_states.end());
	}
	void State::set_easyrpg_immune_states(const QList<bool>& new_easyrpg_immune_states) {
		if (QList<bool>(m_data.easyrpg_immune_states.begin(), m_data.easyrpg_immune_states.end()) == new_easyrpg_immune_states)
			return;
