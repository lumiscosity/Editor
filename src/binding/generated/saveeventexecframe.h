...
class SaveEventExecFrame : public Binding::BindingBase {
	...
	Q_PROPERTY(QList<int> subcommand_path READ subcommand_path WRITE set_subcommand_path NOTIFY subcommand_path_changed)
	...
	Q_PROPERTY(QList<int> maniac_loop_info READ maniac_loop_info WRITE set_maniac_loop_info NOTIFY maniac_loop_info_changed)
...
public:
	...
	QList<int> subcommand_path();
	void set_subcommand_path(const QList<int>& new_subcommand_path);
	...
	QList<int> maniac_loop_info();
	void set_maniac_loop_info(const QList<int>& new_maniac_loop_info);
