...
namespace Binding::Generated {
	...
	int SavePicture::easyrpg_type() {
		return m_data.easyrpg_type;
	}
	void SavePicture::set_easyrpg_type(const int& new_easyrpg_type) {
		if (m_data.easyrpg_type == new_easyrpg_type)
			return;
		m_data.easyrpg_type = new_easyrpg_type;
		emit easyrpg_type_changed();
	}

	double SavePicture::maniac_current_magnify_height() {
		return m_data.maniac_current_magnify_height;
	}
	void SavePicture::set_maniac_current_magnify_height(const double& new_maniac_current_magnify_height) {
		if (m_data.maniac_current_magnify_height == new_maniac_current_magnify_height)
			return;
		m_data.maniac_current_magnify_height = new_maniac_current_magnify_height;
		emit maniac_current_magnify_height_changed();
	}

	int SavePicture::maniac_finish_magnify_height() {
		return m_data.maniac_finish_magnify_height;
	}
	void SavePicture::set_maniac_finish_magnify_height(const int& new_maniac_finish_magnify_height) {
		if (m_data.maniac_finish_magnify_height == new_maniac_finish_magnify_height)
			return;
		m_data.maniac_finish_magnify_height = new_maniac_finish_magnify_height;
		emit maniac_finish_magnify_height_changed();
	}
