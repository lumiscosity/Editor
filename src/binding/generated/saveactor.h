...
class SaveActor : public Binding::BindingBase {
	...
	Q_PROPERTY(QList<int> skills READ skills WRITE set_skills NOTIFY skills_changed)
	Q_PROPERTY(QList<int> equipped READ equipped WRITE set_equipped NOTIFY equipped_changed)
	...
	Q_PROPERTY(QList<int> status READ status WRITE set_status NOTIFY status_changed)
...
public:
	...
	QList<int> skills();
	void set_skills(const QList<int>& new_skills);
	QList<int> equipped();
	void set_equipped(const QList<int>& new_equipped);
	int current_hp();
	...
	QList<int> status();
	void set_status(const QList<int>& new_status);
