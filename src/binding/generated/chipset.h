...
class Chipset : public Binding::BindingBase {
	...
	Q_PROPERTY(QList<int> terrain_data READ terrain_data WRITE set_terrain_data NOTIFY terrain_data_changed)
	Q_PROPERTY(QList<int> passable_data_lower READ passable_data_lower WRITE set_passable_data_lower NOTIFY passable_data_lower_changed)
	Q_PROPERTY(QList<int> passable_data_upper READ passable_data_upper WRITE set_passable_data_upper NOTIFY passable_data_upper_changed)
...
public:
	...
	QList<int> terrain_data();
	void set_terrain_data(const QList<int>& new_terrain_data);
	QList<int> passable_data_lower();
	void set_passable_data_lower(const QList<int>& new_passable_data_lower);
	QList<int> passable_data_upper();
	void set_passable_data_upper(const QList<int>& new_passable_data_upper);
	int animation_type();
