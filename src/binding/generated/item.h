...
class Item : public Binding::BindingBase {
	...
	Q_PROPERTY(QList<bool> actor_set READ actor_set WRITE set_actor_set NOTIFY actor_set_changed)
	Q_PROPERTY(QList<bool> state_set READ state_set WRITE set_state_set NOTIFY state_set_changed)
	Q_PROPERTY(QList<bool> attribute_set READ attribute_set WRITE set_attribute_set NOTIFY attribute_set_changed)
	...
	Q_PROPERTY(QList<bool> class_set READ class_set WRITE set_class_set NOTIFY class_set_changed)
...
public:
	...
	QList<bool> actor_set();
	void set_actor_set(const QList<bool>& new_actor_set);
	QList<bool> state_set();
	void set_state_set(const QList<bool>& new_state_set);
	QList<bool> attribute_set();
	void set_attribute_set(const QList<bool>& new_attribute_set);
	int state_chance();
	...
	QList<bool> class_set();
	void set_class_set(const QList<bool>& new_class_set);
