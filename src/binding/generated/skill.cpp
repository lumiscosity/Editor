...
namespace Binding::Generated {
	...
	QList<bool> Skill::state_effects() {
		return QList<bool>(m_data.state_effects.begin(), m_data.state_effects.end());
	}
	void Skill::set_state_effects(const QList<bool>& new_state_effects) {
		if (QList<bool>(m_data.state_effects.begin(), m_data.state_effects.end()) == new_state_effects)
			return;
	...
	QList<bool> Skill::attribute_effects() {
		return QList<bool>(m_data.attribute_effects.begin(), m_data.attribute_effects.end());
	}
	void Skill::set_attribute_effects(const QList<bool>& new_attribute_effects) {
		if (QList<bool>(m_data.attribute_effects.begin(), m_data.attribute_effects.end()) == new_attribute_effects)
			return;
