...
class BattleCommands : public Binding::BindingBase {
	...
	Q_PROPERTY(int easyrpg_fixed_actor_facing_direction READ easyrpg_fixed_actor_facing_direction WRITE set_easyrpg_fixed_actor_facing_direction NOTIFY easyrpg_fixed_actor_facing_direction_changed)
	Q_PROPERTY(int easyrpg_fixed_enemy_facing_direction READ easyrpg_fixed_enemy_facing_direction WRITE set_easyrpg_fixed_enemy_facing_direction NOTIFY easyrpg_fixed_enemy_facing_direction_changed)
...
public:
	...
	int easyrpg_fixed_actor_facing_direction();
	void set_easyrpg_fixed_actor_facing_direction(const int& new_easyrpg_fixed_actor_facing_direction);
	int easyrpg_fixed_enemy_facing_direction();
	void set_easyrpg_fixed_enemy_facing_direction(const int& new_easyrpg_fixed_enemy_facing_direction);
...
signals:
	...
	void easyrpg_fixed_actor_facing_direction_changed();
	void easyrpg_fixed_enemy_facing_direction_changed();
