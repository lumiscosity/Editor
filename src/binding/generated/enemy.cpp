...
namespace Binding::Generated {
	...
	QList<int> Enemy::state_ranks() {
		return QList<int>(m_data.state_ranks.begin(), m_data.state_ranks.end());
	}
	void Enemy::set_state_ranks(const QList<int>& new_state_ranks) {
	...
	QList<int> Enemy::attribute_ranks() {
		return QList<int>(m_data.attribute_ranks.begin(), m_data.attribute_ranks.end());
	}
	void Enemy::set_attribute_ranks(const QList<int>& new_attribute_ranks) {
	...
	QList<bool> Enemy::easyrpg_state_set() {
		return QList<bool>(m_data.easyrpg_state_set.begin(), m_data.easyrpg_state_set.end());
	}
	void Enemy::set_easyrpg_state_set(const QList<bool>& new_easyrpg_state_set) {
		if (QList<bool>(m_data.easyrpg_state_set.begin(), m_data.easyrpg_state_set.end()) == new_easyrpg_state_set)
			return;
	...
	QList<bool> Enemy::easyrpg_attribute_set() {
		return QList<bool>(m_data.easyrpg_attribute_set.begin(), m_data.easyrpg_attribute_set.end());
	}
	void Enemy::set_easyrpg_attribute_set(const QList<bool>& new_easyrpg_attribute_set) {
		if (QList<bool>(m_data.easyrpg_attribute_set.begin(), m_data.easyrpg_attribute_set.end()) == new_easyrpg_attribute_set)
			return;
