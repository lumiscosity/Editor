...
namespace Binding::Generated {
	...
	int SaveMapInfo::encounter_steps() {
		return m_data.encounter_steps;
	}
	void SaveMapInfo::set_encounter_steps(const int& new_encounter_steps) {
	...
	QList<int> SaveMapInfo::lower_tiles() {
		return QList<int>(m_data.lower_tiles.begin(), m_data.lower_tiles.end());
	}
	void SaveMapInfo::set_lower_tiles(const QList<int>& new_lower_tiles) {
		if (QList<int>(m_data.lower_tiles.begin(), m_data.lower_tiles.end()) == new_lower_tiles)
			return;
		m_data.lower_tiles = decltype(m_data.lower_tiles)(new_lower_tiles.begin(), new_lower_tiles.end());
		emit lower_tiles_changed();
	}

	QList<int> SaveMapInfo::upper_tiles() {
		return QList<int>(m_data.upper_tiles.begin(), m_data.upper_tiles.end());
	}
	void SaveMapInfo::set_upper_tiles(const QList<int>& new_upper_tiles) {
		if (QList<int>(m_data.upper_tiles.begin(), m_data.upper_tiles.end()) == new_upper_tiles)
			return;
