...
class Skill : public Binding::BindingBase {
	...
	Q_PROPERTY(QList<bool> state_effects READ state_effects WRITE set_state_effects NOTIFY state_effects_changed)
	Q_PROPERTY(QList<bool> attribute_effects READ attribute_effects WRITE set_attribute_effects NOTIFY attribute_effects_changed)
...
public:
	...
	QList<bool> state_effects();
	void set_state_effects(const QList<bool>& new_state_effects);
	QList<bool> attribute_effects();
	void set_attribute_effects(const QList<bool>& new_attribute_effects);
