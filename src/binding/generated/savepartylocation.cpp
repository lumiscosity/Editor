...
namespace Binding::Generated {
	...
	int SavePartyLocation::total_encounter_rate() {
		return m_data.total_encounter_rate;
	}
	void SavePartyLocation::set_total_encounter_rate(const int& new_total_encounter_rate) {
		if (m_data.total_encounter_rate == new_total_encounter_rate)
			return;
		m_data.total_encounter_rate = new_total_encounter_rate;
		emit total_encounter_rate_changed();
	}
