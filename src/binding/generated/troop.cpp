...
namespace Binding::Generated {
	...
	QList<bool> Troop::terrain_set() {
		return QList<bool>(m_data.terrain_set.begin(), m_data.terrain_set.end());
	}
	void Troop::set_terrain_set(const QList<bool>& new_terrain_set) {
		if (QList<bool>(m_data.terrain_set.begin(), m_data.terrain_set.end()) == new_terrain_set)
			return;
