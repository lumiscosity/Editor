...
namespace Binding::Generated {
	...
	QList<int> Class::state_ranks() {
		return QList<int>(m_data.state_ranks.begin(), m_data.state_ranks.end());
	}
	void Class::set_state_ranks(const QList<int>& new_state_ranks) {
	...
	QList<int> Class::attribute_ranks() {
		return QList<int>(m_data.attribute_ranks.begin(), m_data.attribute_ranks.end());
	}
	void Class::set_attribute_ranks(const QList<int>& new_attribute_ranks) {
	...
	QList<int> Class::battle_commands() {
		return QList<int>(m_data.battle_commands.begin(), m_data.battle_commands.end());
	}
	void Class::set_battle_commands(const QList<int>& new_battle_commands) {
