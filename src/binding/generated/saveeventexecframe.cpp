...
namespace Binding::Generated {
	...
	QList<int> SaveEventExecFrame::subcommand_path() {
		return QList<int>(m_data.subcommand_path.begin(), m_data.subcommand_path.end());
	}
	void SaveEventExecFrame::set_subcommand_path(const QList<int>& new_subcommand_path) {
		if (QList<int>(m_data.subcommand_path.begin(), m_data.subcommand_path.end()) == new_subcommand_path)
			return;
	...
	QList<int> SaveEventExecFrame::maniac_loop_info() {
		return QList<int>(m_data.maniac_loop_info.begin(), m_data.maniac_loop_info.end());
	}
	void SaveEventExecFrame::set_maniac_loop_info(const QList<int>& new_maniac_loop_info) {
		if (QList<int>(m_data.maniac_loop_info.begin(), m_data.maniac_loop_info.end()) == new_maniac_loop_info)
			return;
