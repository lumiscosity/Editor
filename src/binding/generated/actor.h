...
class Actor : public Binding::BindingBase {
	...
	Q_PROPERTY(QList<int> state_ranks READ state_ranks WRITE set_state_ranks NOTIFY state_ranks_changed)
	Q_PROPERTY(QList<int> attribute_ranks READ attribute_ranks WRITE set_attribute_ranks NOTIFY attribute_ranks_changed)
	Q_PROPERTY(QList<int> battle_commands READ battle_commands WRITE set_battle_commands NOTIFY battle_commands_changed)
	...
	Q_PROPERTY(QList<bool> easyrpg_unarmed_state_set READ easyrpg_unarmed_state_set WRITE set_easyrpg_unarmed_state_set NOTIFY easyrpg_unarmed_state_set_changed)
	...
	Q_PROPERTY(QList<bool> easyrpg_unarmed_attribute_set READ easyrpg_unarmed_attribute_set WRITE set_easyrpg_unarmed_attribute_set NOTIFY easyrpg_unarmed_attribute_set_changed)
...
public:
	...
	void set_state_ranks(const QList<int>& new_state_ranks);
	QList<int> attribute_ranks();
	void set_attribute_ranks(const QList<int>& new_attribute_ranks);
	QList<int> battle_commands();
	void set_battle_commands(const QList<int>& new_battle_commands);
	int easyrpg_actorai();
	...
	QList<bool> easyrpg_unarmed_state_set();
	void set_easyrpg_unarmed_state_set(const QList<bool>& new_easyrpg_unarmed_state_set);
	int easyrpg_unarmed_state_chance();
	void set_easyrpg_unarmed_state_chance(const int& new_easyrpg_unarmed_state_chance);
	QList<bool> easyrpg_unarmed_attribute_set();
	void set_easyrpg_unarmed_attribute_set(const QList<bool>& new_easyrpg_unarmed_attribute_set);
