...
namespace Binding::Generated {
	...
	QList<int> EventCommand::parameters() {
		return QList<int>(m_data.parameters.begin(), m_data.parameters.end());
	}
	void EventCommand::set_parameters(const QList<int>& new_parameters) {
		if (QList<int>(m_data.parameters.begin(), m_data.parameters.end()) == new_parameters)
			return;
