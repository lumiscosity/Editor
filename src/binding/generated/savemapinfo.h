...
class SaveMapInfo : public Binding::BindingBase {
	...
	Q_PROPERTY(QList<int> lower_tiles READ lower_tiles WRITE set_lower_tiles NOTIFY lower_tiles_changed)
	Q_PROPERTY(QList<int> upper_tiles READ upper_tiles WRITE set_upper_tiles NOTIFY upper_tiles_changed)
...
public:
	...
	ArrayAdapter* events();
	QList<int> lower_tiles();
	void set_lower_tiles(const QList<int>& new_lower_tiles);
	QList<int> upper_tiles();
	void set_upper_tiles(const QList<int>& new_upper_tiles);
