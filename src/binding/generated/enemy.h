...
class Enemy : public Binding::BindingBase {
	...
	Q_PROPERTY(QList<bool> easyrpg_state_set READ easyrpg_state_set WRITE set_easyrpg_state_set NOTIFY easyrpg_state_set_changed)
	...
	Q_PROPERTY(QList<bool> easyrpg_attribute_set READ easyrpg_attribute_set WRITE set_easyrpg_attribute_set NOTIFY easyrpg_attribute_set_changed)
...
public:
	...
	QList<bool> easyrpg_state_set();
	void set_easyrpg_state_set(const QList<bool>& new_easyrpg_state_set);
	int easyrpg_state_chance();
	void set_easyrpg_state_chance(const int& new_easyrpg_state_chance);
	QList<bool> easyrpg_attribute_set();
	void set_easyrpg_attribute_set(const QList<bool>& new_easyrpg_attribute_set);
