...
namespace Binding::Generated {
	...
	QList<int> System::party() {
		return QList<int>(m_data.party.begin(), m_data.party.end());
	}
	void System::set_party(const QList<int>& new_party) {
	...
	QList<int> System::menu_commands() {
		return QList<int>(m_data.menu_commands.begin(), m_data.menu_commands.end());
	}
	void System::set_menu_commands(const QList<int>& new_menu_commands) {
		if (QList<int>(m_data.menu_commands.begin(), m_data.menu_commands.end()) == new_menu_commands)
			return;
	...
	QList<int> System::easyrpg_battle_options() {
		return QList<int>(m_data.easyrpg_battle_options.begin(), m_data.easyrpg_battle_options.end());
	}
	void System::set_easyrpg_battle_options(const QList<int>& new_easyrpg_battle_options) {
		if (QList<int>(m_data.easyrpg_battle_options.begin(), m_data.easyrpg_battle_options.end()) == new_easyrpg_battle_options)
			return;
