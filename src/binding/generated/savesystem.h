...
class SaveSystem : public Binding::BindingBase {
	...
	Q_PROPERTY(QList<bool> switches READ switches WRITE set_switches NOTIFY switches_changed)
	Q_PROPERTY(QList<int> variables READ variables WRITE set_variables NOTIFY variables_changed)
	...
	Q_PROPERTY(QList<QString> maniac_strings READ maniac_strings WRITE set_maniac_strings NOTIFY maniac_strings_changed)
	...
	Q_PROPERTY(QList<int> maniac_options READ maniac_options WRITE set_maniac_options NOTIFY maniac_options_changed)
	Q_PROPERTY(QList<int> maniac_joypad_bindings READ maniac_joypad_bindings WRITE set_maniac_joypad_bindings NOTIFY maniac_joypad_bindings_changed)
...
public:
	...
	QList<bool> switches();
	void set_switches(const QList<bool>& new_switches);
	QList<int> variables();
	void set_variables(const QList<int>& new_variables);
	...
	QList<QString> maniac_strings();
	void set_maniac_strings(const QList<QString>& new_maniac_strings);
	...
	QList<int> maniac_options();
	void set_maniac_options(const QList<int>& new_maniac_options);
	QList<int> maniac_joypad_bindings();
	void set_maniac_joypad_bindings(const QList<int>& new_maniac_joypad_bindings);
